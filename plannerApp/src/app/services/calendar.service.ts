...
export class CalendarService {
    ...
    const todos: ToDo[] = [
      {
        ...
        listOfItems: [ { id: 101, title: 'Task 1', createdDate: new Date('11-6-2021'),
        startDate: new Date('11-7-2021'), endDate: new Date('11-7-2021') },
      ...
      },
      {
        ...
        listOfItems: [ { id: 105, title: 'Task 11', createdDate: new Date('11-6-2021'),
        startDate: new Date('11-7-2021'), endDate: new Date('11-7-2021') },
  ...
  private createToDoAsEventObject(todo: ToDo): any {
    ...
    // new Date(note.startDate.toString().split('GMT')[0] + ' UTC').toISOString();
    return { id: todo.id.toString(), title: todo.todoTitle, start: startStr,
